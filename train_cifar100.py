...
parser.add_argument('--dataset', type=str, default='cifar100', choices=[ 'cifar100', 'cinic10'])
...
if args.dataset == 'cifar100':
    args.save = '/raid/data/zhangchuang/code/zhangchuang/EEEA-Net/outputs100/eval-cifar100-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
if args.dataset == 'cinic10':
    args.save = '/raid/data/zhangchuang/code/zhangchuang/EEEA-Net/outputs/eval-cinic10-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
