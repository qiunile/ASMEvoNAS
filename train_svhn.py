...
parser.add_argument('--dataset', type=str, default='svhn', choices=['cifar10', 'cifar100', 'cinic10'])
...
if args.dataset == 'svhn':
    args.save = '/raid/data/zhangchuang/code/zhangchuang/EEEA-Net/output6/eval-svhn-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
