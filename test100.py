...
parser.add_argument('--data', type=str, default='/raid/data/zhangchuang/code/zhangchuang/data', help='location of the data corpus')
parser.add_argument('--batch_size', type=int, default=32, help='batch size')
parser.add_argument('--report_freq', type=float, default=50, help='report frequency')
parser.add_argument('--gpus', type=str, default='5', help='gpu device id')
parser.add_argument('--init_channels', type=int, default=36, help='num of init channels')
parser.add_argument('--layers', type=int, default=20, help='total number of layers')
parser.add_argument('--model_path', type=str, default='/raid/data/zhangchuang/code/zhangchuang/EEEA-Net/outputs100/53-AA-PY-83.88/model_best.pth.tar',
                    help='path of pretrained model')
parser.add_argument('--auxiliary', action='store_true', default=False, help='use auxiliary tower')
parser.add_argument('--cutout', action='store_true', default=True, help='use cutout')
argument = parser.add_argument('--cutout_length', type=int, default=16, help='cutout length')
...
parser.add_argument('--set', type=str, default="cifar100", help='data set')
